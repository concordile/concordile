...
public interface DeploymentTargetEntityMapper
        extends EntityMapper<DeploymentTargetEntity, DeploymentTarget> {

    @Override
    DeploymentTarget mapEntity2Domain(DeploymentTargetEntity entity);
