...
public interface DeploymentTargetResponseMapper
        extends ResponseMapper<DeploymentTarget, DeploymentTargetResponse> {

    @Override
    DeploymentTargetResponse mapDomain2Response(DeploymentTarget domain);
