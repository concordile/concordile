...
public interface CreateDeploymentRecordRequestMapper
        extends RequestMapper<CreateDeploymentRecordRequest, CreateDeploymentRecordCommand> {

    @Override
    CreateDeploymentRecordCommand mapRequest2Command(CreateDeploymentRecordRequest request);
