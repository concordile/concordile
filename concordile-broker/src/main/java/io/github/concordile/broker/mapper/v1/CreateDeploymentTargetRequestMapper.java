...
public interface CreateDeploymentTargetRequestMapper
        extends RequestMapper<CreateDeploymentTargetRequest, CreateDeploymentTargetCommand> {

    @Override
    CreateDeploymentTargetCommand mapRequest2Command(CreateDeploymentTargetRequest request);
