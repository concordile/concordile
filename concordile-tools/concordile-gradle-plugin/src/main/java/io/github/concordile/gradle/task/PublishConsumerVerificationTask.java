...
import io.github.concordile.gradle.mapper.ConsumerVerificationRequestMapper;
...
public abstract class PublishConsumerVerificationTask extends DefaultTask {

    private final JsonMapper jsonMapper = new JsonMapper();

    private final JUnitXmlTestResultReader testResultReader = new JUnitXmlTestResultReader();

    private final ConsumerVerificationRequestMapper requestMapper = new ConsumerVerificationRequestMapper();
    ...
    public void publish() throws Exception {
        var context = jsonMapper.readValue(
                ...
                ConsumerVerificationContext.class
        );
